...
class LessonModel extends Model
{
    ...
    protected $fillable = ['title','video','content','parent_id','_lft','_rgt','created_at','updated_at'];
    use HasFactory;
    public function listItems($params = "", $options = "")
    {
        $result = null;
        $query = $this->select('id','title','video','content','parent_id','_lft','_rgt','created_at','updated_at');
